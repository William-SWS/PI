...
|-----------|---------------|-----------|
| ![Média 3x3](saidas/saidas_questao1/q1_h1.png) | ![Gaussiano 5x5](saidas/saidas_questao1/q1_h2.png) | ![Média 5x5](saidas/saidas_questao1/q1_h10.png) |
...
|---------|---------|-----------|-----------|
| ![Sobel X](saidas/saidas_questao1/q1_h3.png) | ![Sobel Y](saidas/saidas_questao1/q1_h4.png) | ![Prewitt X](saidas/saidas_questao1/q1_h5.png) | ![Prewitt Y](saidas/saidas_questao1/q1_h6.png) |
...
|-------------|------------|--------|--------------|
| ![Laplaciano](saidas/saidas_questao1/q1_h7.png) | ![Sharpening](saidas/saidas_questao1/q1_h8.png) | ![Emboss](saidas/saidas_questao1/q1_h9.png) | ![Unsharp Mask](saidas/saidas_questao1/q1_h11.png) |
...
![Espectro FFT Centralizado](saidas/saidas_questao2/00_fft/fft_espectro_centralizado.png)
...
|------------------|------------------|------------------|
| ![Mask PB r15](saidas/saidas_questao2/01_masks/mask_passabaixa_r15.png) | ![Mask PB r30](saidas/saidas_questao2/01_masks/mask_passabaixa_r30.png) | ![Mask PB r60](saidas/saidas_questao2/01_masks/mask_passabaixa_r60.png) |

| Passa-Alta r=15 | Passa-Alta r=30 | Passa-Alta r=60 |
|-----------------|-----------------|-----------------|
| ![Mask PA r15](saidas/saidas_questao2/01_masks/mask_passaalta_r15.png) | ![Mask PA r30](saidas/saidas_questao2/01_masks/mask_passaalta_r30.png) | ![Mask PA r60](saidas/saidas_questao2/01_masks/mask_passaalta_r60.png) |

| Passa-Faixa 10-30 | Passa-Faixa 20-50 | Rejeita-Faixa 10-30 | Rejeita-Faixa 20-50 |
|-------------------|-------------------|---------------------|---------------------|
| ![Mask PF 10-30](saidas/saidas_questao2/01_masks/mask_passafaixa_r10_30.png) | ![Mask PF 20-50](saidas/saidas_questao2/01_masks/mask_passafaixa_r20_50.png) | ![Mask RF 10-30](saidas/saidas_questao2/01_masks/mask_rejeitafaixa_r10_30.png) | ![Mask RF 20-50](saidas/saidas_questao2/01_masks/mask_rejeitafaixa_r20_50.png) |
...
| Passa-Baixa r=15 | Passa-Baixa r=30 | Passa-Baixa r=60 |
|------------------|------------------|------------------|
| ![PB r15](saidas/saidas_questao2/02_filtradas/filtro_passabaixa_r15.png) | ![PB r30](saidas/saidas_questao2/02_filtradas/filtro_passabaixa_r30.png) | ![PB r60](saidas/saidas_questao2/02_filtradas/filtro_passabaixa_r60.png) |

| Passa-Alta r=15 | Passa-Alta r=30 | Passa-Alta r=60 |
|-----------------|-----------------|-----------------|
| ![PA r15](saidas/saidas_questao2/02_filtradas/filtro_passaalta_r15.png) | ![PA r30](saidas/saidas_questao2/02_filtradas/filtro_passaalta_r30.png) | ![PA r60](saidas/saidas_questao2/02_filtradas/filtro_passaalta_r60.png) |

| Passa-Faixa 10-30 | Passa-Faixa 20-50 | Rejeita-Faixa 10-30 | Rejeita-Faixa 20-50 |
|-------------------|-------------------|---------------------|---------------------|
| ![PF 10-30](saidas/saidas_questao2/02_filtradas/filtro_passafaixa_r10_30.png) | ![PF 20-50](saidas/saidas_questao2/02_filtradas/filtro_passafaixa_r20_50.png) | ![RF 10-30](saidas/saidas_questao2/02_filtradas/filtro_rejeitafaixa_r10_30.png) | ![RF 20-50](saidas/saidas_questao2/02_filtradas/filtro_rejeitafaixa_r20_50.png) |
...
|---------------------------|---------------------------|---------------------------|
| ![Espectro PB r15](saidas/saidas_questao2/02_filtradas/espectro_passabaixa_r15.png) | ![Espectro PB r30](saidas/saidas_questao2/02_filtradas/espectro_passabaixa_r30.png) | ![Espectro PB r60](saidas/saidas_questao2/02_filtradas/espectro_passabaixa_r60.png) |

| Espectro Passa-Alta r=15 | Espectro Passa-Alta r=30 | Espectro Passa-Alta r=60 |
|--------------------------|--------------------------|--------------------------|
| ![Espectro PA r15](saidas/saidas_questao2/02_filtradas/espectro_passaalta_r15.png) | ![Espectro PA r30](saidas/saidas_questao2/02_filtradas/espectro_passaalta_r30.png) | ![Espectro PA r60](saidas/saidas_questao2/02_filtradas/espectro_passaalta_r60.png) |

| Espectro Passa-Faixa 10-30 | Espectro Passa-Faixa 20-50 | Espectro Rejeita-Faixa 10-30 | Espectro Rejeita-Faixa 20-50 |
|---------------------------|---------------------------|-------------------------------|-------------------------------|
| ![Espectro PF 10-30](saidas/saidas_questao2/02_filtradas/espectro_passafaixa_r10_30.png) | ![Espectro PF 20-50](saidas/saidas_questao2/02_filtradas/espectro_passafaixa_r20_50.png) | ![Espectro RF 10-30](saidas/saidas_questao2/02_filtradas/espectro_rejeitafaixa_r10_30.png) | ![Espectro RF 20-50](saidas/saidas_questao2/02_filtradas/espectro_rejeitafaixa_r20_50.png) |
...
|----------------|----------------|----------------|
| ![Compressão P70](saidas/saidas_questao2/03_compressao/compressao_percentil_70.png) | ![Compressão P85](saidas/saidas_questao2/03_compressao/compressao_percentil_85.png) | ![Compressão P95](saidas/saidas_questao2/03_compressao/compressao_percentil_95.png) |
...
![Histograma Original](saidas/saidas_questao2/04_histogramas/histograma_original.png)
...
![Histograma P70](saidas/saidas_questao2/04_histogramas/histograma_p70.png)
...
![Histograma P85](saidas/saidas_questao2/04_histogramas/histograma_p85.png)
...
![Histograma P95](saidas/saidas_questao2/04_histogramas/histograma_p95.png)
...
![Comparativo de Histogramas](saidas/saidas_questao2/04_histogramas/comparativo_histogramas_original_vs_comprimidas.png)
